  ...
  public ExpenseDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfExpense = new EntityInsertionAdapter<Expense>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `Expense` (`id`,`amount`,`description`,`groupId`,`date`) VALUES (nullif(?, 0),?,?,?,?)";
      }
  ...
  public List<Expense> selectAllExpense() {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        _item = new Expense(_tmpAmount,_tmpDescription,_tmpGroupId,_tmpDate);
        final int _tmpId;
