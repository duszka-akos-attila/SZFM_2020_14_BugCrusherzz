  ...
  public TemplateDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTemplate = new EntityInsertionAdapter<Template>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `Template` (`isIncome`,`id`,`amount`,`description`,`groupId`) VALUES (?,?,?,?,?)";
      }
  ...
  public List<Template> selectAllTemplate() {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        _item = new Template(_tmpIsIncome,_tmpId,_tmpAmount,_tmpDescription,_tmpGroupId);
        _result.add(_item);
      }
      return _result;
    } finally {
